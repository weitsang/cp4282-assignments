...
The check is intentionally tiny. It compares your explicit Warp backward pass with central
...
compact-box culling, and the position learning-rate schedule.
"""
...
def check_parameter_gradients(device: str) -> None:
    ...
    cases = [
        ...
        ("base green", trainer.colors, wp.vec3, (0, 1)),
    ]
